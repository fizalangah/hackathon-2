...
@patch('builtins.input', side_effect=['Update Task', 'some-id', 'New Title', 'New Desc', 'Exit'])
@patch('builtins.print')
def test_cli_update_task_success(mock_print, mock_input, mock_task_service):
...
@patch('builtins.input', side_effect=['Update Task', 'non-existent-id', 'New Title', '', 'Exit'])
@patch('builtins.print')
def test_cli_update_task_not_found_error(mock_print, mock_input, mock_task_service):
